...
router.post('/api/etherscan/history', function(req, res, next){
  ...
  const url = `https://api.etherscan.io/api/api?module=account&action=txlist&address=${address}&startblock=0&endblock=99999999&sort=asc&apikey=${API_KEY}`;
